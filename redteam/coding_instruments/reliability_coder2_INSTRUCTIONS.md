...
Another researcher has coded this material independently. You will not see their
codes, and they will not see yours. We are measuring how far two careful readers
agree when applying the same rule, so please work from the rule as written rather
than from what you think we are hoping to find.
...
File to code: `reliability_coder2_sheet.csv` (60 rows)
Return to: Madhav Mukherjee
Estimated time: about 1h 30m to 2h 30m
